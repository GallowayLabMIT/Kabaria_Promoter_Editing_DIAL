...
filepath_noCre = '/Users/yunbeenbae/Documents/GitHub/Cre-loxP-ZF-promoters/flow_analysis_scripts/2024_promoter_editing_paper/datafiles/modeling_MEAN_noCre_ZF43titration.xlsx';
filepath_Cre = '/Users/yunbeenbae/Documents/GitHub/Cre-loxP-ZF-promoters/flow_analysis_scripts/2024_promoter_editing_paper/datafiles/modeling_MEAN_Cre_ZF43titration.xlsx';

data_noCre = readmatrix(filepath_noCre);
data_Cre = readmatrix(filepath_Cre);

x_zf_noCre = data_noCre(:,3); % TagBFP-A
y_rna_noCre = data_noCre(:,2); % mGL-A

x_zf_Cre = data_Cre(:,3); % TagBFP-A
y_rna_Cre = data_Cre(:,2); % mGL-A

%% removing burden points -- seems only necessary for ZF
...
hold on;
plot(x_zf_noCre, predictions_noCre, 'b-', 'DisplayName', 'No Cre Model Predictions');
xlabel('TagBFP-A Normalized by gmean of ZF43 0.125x');
ylabel('mGL-A  Normalized by gmean of ZF43 0.125x');
title('Scatterplot Normalized by ZF43 0.125x with Fitted model');
legend;
